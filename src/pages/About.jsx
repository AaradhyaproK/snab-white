...
const DEFAULT_ACCOLADES = [
  {
    ...
    title: "Yi IDS 6.0 Hackathon",
    desc: "Awarded First Prize along with a cash reward of INR 10,000 at the Young Indians Ideas Showcase (IDS 6.0) hackathon, recognizing our team's rapid prototyping and engineering capability."
  },
  {
    badge: "Selected Startup",
    title: "Eureka 2025 — IIT Bombay",
    desc: "Our AI-powered legal platform was selected in the prestigious Eureka 2025 startup showcase hosted by IIT Bombay, validating our core technology among India's top innovations."
  },
  {
    badge: "Runner-Up",
    title: "Startup Arena Pitching",
    desc: "Secured the Runner-up position in the Startup Arena pitching showcase, demonstrating commercial viability, pitch traction, and scalable technical implementation."
  }
];
      ...
      <section className="why-section" style={{ backgroundColor: 'var(--color-bg)', borderTop: '1px solid #E5E7EB', padding: '80px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto' }}>
          {accolades.map((acc, idx) => (
            <div className="why-card" key={acc.id || idx} style={{ padding: '30px', borderRadius: '16px', border: '1px solid var(--color-border)', backgroundColor: '#FFFFFF' }}>
              <span style={{ fontSize: '0.8rem', color: '#2563EB', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '0.08em' }}>
                {acc.badge}
              </span>
      ...
      <section className="why-section" style={{ backgroundColor: 'transparent', borderTop: '1px solid #E5E7EB' }}>
        ...
        <div className="why-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '30px', maxWidth: '1200px', margin: '0 auto' }}>
          {whyChooseUs.map((item, idx) => (
            <div className="why-card" key={item.id || idx} style={{ padding: '30px', borderRadius: '16px', border: '1px solid var(--color-border)', backgroundColor: '#FFFFFF' }}>
